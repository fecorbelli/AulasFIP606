...
#adicionar os resultados em uma tabela
library(writex1)
write_xlxs(df_prod, "df.xlsx")
```
...
A AUDPC é uma medida utilizada para quantificar e comparar o progresso de doenças em plantas ao longo do tempo. A curva do progresso da doença apresenta o tempo no eixo x e a variável de interesse no eixo y.
Utilizamos o elemento `AUDPC()` na camada summarise. 
