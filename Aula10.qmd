...
Quanto maior a correlação, menor p-valor
...
AIC(lm3)
```
Interpretação: Maior o valor de r2 no segundo modelo, então o modelo quadrático explica melhor a relação entre variáveis. 
Função = 66,3 - 1,77* TRAT + 0,02* TRAT2
...
r2 - o quanto de y é explicado por x
r - força de associação entre x e y
